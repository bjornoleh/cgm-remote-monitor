...
{#if reportDetails}
  {#if reportDetails.dateRange}
    <div class="text-center text-sm text-muted-foreground mb-6">
      Showing data from {reportDetails.dateRange.from} to {reportDetails
        .dateRange.to}
    ...
    {#if currentStats?.glycemicVariability}
      <div class="bg-white shadow-lg rounded-lg p-4 md:p-6 mb-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          ...
          <!-- Risk Indices -->
          <div class="bg-gray-50 rounded-lg p-4">
            <h3 class="text-sm font-medium text-gray-600 mb-2">Risk Indices</h3>
            <div class="space-y-2">
              <div class="flex justify-between">
        ...
        <div class="mt-4 p-3 bg-blue-50 rounded-lg">
          ...
          <div class="text-xs text-blue-700 space-y-1">
            <p>
              ...
              High/Low Blood Glucose Index - risk indices for hyperglycemia and hypoglycemia.

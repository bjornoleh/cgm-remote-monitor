...
<script lang="ts">
	...
	const eventTypes: EventType[] = [
		...
		{ val: 'Snack Bolus', name: 'Snack Bolus', insulin: true, carbs: true, protein: true, fat: true, prebolus: true },
		{ val: 'Meal Bolus', name: 'Meal Bolus', insulin: true, carbs: true, protein: true, fat: true, prebolus: true },
		{ val: 'Correction Bolus', name: 'Correction Bolus', insulin: true, bg: true, glucoseType: true },
		{ val: 'Carb Correction', name: 'Carb Correction', carbs: true, bg: true, glucoseType: true },
		{ val: 'Combo Bolus', name: 'Combo Bolus', insulin: true, carbs: true, protein: true, fat: true, duration: true },
		...
		{ val: 'Temp Basal', name: 'Temp Basal', duration: true, percent: true, absolute: true },
		{ val: 'Profile Switch', name: 'Profile Switch', profile: true, duration: true },
		...
		{ val: 'Temporary Target', name: 'Temporary Target', targets: true, duration: true,
		  reasons: [
	...
	function onReasonChange() {
		if (selectedReason && selectedEvent?.reasons) {
			const reason = selectedEvent.reasons.find(r => r.name === selectedReason);
			if (reason) {
				...
				{#if selectedEvent.insulin}
					<div class="input-row">
						...
						<div class="input-with-units">
							...
							<button type="button" class="quick-fill-btn" onclick={quickFillFromCalculator}>
								Use Calculator
							</button>
						</div>
					</div>
